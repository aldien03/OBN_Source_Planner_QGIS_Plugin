...
class Ui_OBNPlannerDockWidgetBase(object):
    def setupUi(self, OBNPlannerDockWidgetBase):
        ...
        self.label_optimization_max_iter = QtWidgets.QLabel(self.dockWidgetContents)
        self.label_optimization_max_iter.setObjectName("label_optimization_max_iter")
        self.horizontalLayout_optimization.addWidget(self.label_optimization_max_iter)
        self.optimizationMaxIterationsSpinBox = QtWidgets.QSpinBox(self.dockWidgetContents)
        self.optimizationMaxIterationsSpinBox.setMinimum(10)
        self.optimizationMaxIterationsSpinBox.setMaximum(1000)
        self.optimizationMaxIterationsSpinBox.setSingleStep(10)
        self.optimizationMaxIterationsSpinBox.setProperty("value", 200)
        self.optimizationMaxIterationsSpinBox.setEnabled(False)
        self.optimizationMaxIterationsSpinBox.setObjectName("optimizationMaxIterationsSpinBox")
        self.horizontalLayout_optimization.addWidget(self.optimizationMaxIterationsSpinBox)
    ...
    def retranslateUi(self, OBNPlannerDockWidgetBase):
        ...
        self.sequenceOptimizationComboBox.setToolTip(_translate("OBNPlannerDockWidgetBase", "Reorders the generated sequence to minimize total cost. OR-tools (Guided Local Search) is the recommended choice — it finds near-optimal tours and avoids the long cross-survey transits that 2-opt gets stuck with. 2-opt (legacy) is kept for A/B comparison and will be removed in a future release. Default: Off."))
        ...
        self.sequenceOptimizationComboBox.setItemText(2, _translate("OBNPlannerDockWidgetBase", "2-opt (legacy)"))
        self.label_optimization_max_iter.setText(_translate("OBNPlannerDockWidgetBase", "Max passes:"))
        self.optimizationMaxIterationsSpinBox.setToolTip(_translate("OBNPlannerDockWidgetBase", "Maximum number of 2-opt passes before stopping. Only used when Optimization = 2-opt (legacy). Higher values = better result but longer runtime. Typical: 50 quick / 200 thorough / 500+ very demanding. Grey when not in 2-opt mode."))
